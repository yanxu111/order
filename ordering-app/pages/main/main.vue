<template>
	<view class="page">
		...
		<view class="shop-main">
			<view class="shop-list" v-for="(item,index) in shops" :key="idnex" @click="goPage('/pages/goods/index?branch_shop_id='+item.branch_shop_id)">
...
<script>
	...
	export default {
			...
			uni.getSetting({
				success: (res) => {
					...
					if(res.authSetting['scope.address']){
						...
						this.getShop({"page":1,"lng":this.lng,"lat":this.lat,complete:(res)=>{
							// console.log(res)
		...
		// 下拉刷新
			onPullDownRefresh() {
				this.pageNum=1
				this.getShop({"page":this.pageNum,"lng":this.lng,"lat":this.lat,success:()=>{
...
<style scoped>
	...
	.header{width:100%;background-color:darkred;overflow:hidden;position: fixed;left:0;top:0;z-index:90;}
	...
	.header .search-header.ipx{height:220rpx;}
	...
	.shop-main .shop-list .shop-info .pack-btn{padding:10rpx 20rpx;background-color:darkred;font-size:28rpx;color:#FFFFFF;display: table;border-radius: 5px;float: right;margin-top:10rpx;}
</style>
